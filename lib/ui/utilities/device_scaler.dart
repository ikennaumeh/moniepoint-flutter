...
class DeviceScaler {
  ...
  double _scale(double referenceSize, {double? minSize, bool? canScaleUp = true}) {
  ...
  double _scaleFont(double referenceSize, {bool? canScaleUp = true}) {
    return _scale(referenceSize, minSize: 10, canScaleUp: canScaleUp);
  }
}


extension NumScaler on num {
  double get scale => DeviceScaler()._scale(toDouble());
  double get sf => DeviceScaler()._scaleFont(toDouble());
}